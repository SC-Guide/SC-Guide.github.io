...
**Interactive skincare routine planner** — a portfolio project showcasing front-end development, UX/UI design, and AI-assisted content strategy.
...
| ✅ **"Done" marks** | Checkboxes are saved in your browser's localStorage. |
...
- [ ] Personalised routines per user
